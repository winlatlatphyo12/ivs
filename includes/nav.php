<!-- Navigation-->
        <nav class="navbar navbar-fixed-top navbar-expand-lg px-4 px-lg-5" id="mainNav"> 
            <div class="container-fluid px-4 px-lg-5">
                ...
                <button class="navbar-toggler text-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
                    Menu
                    <i class="fas fa-bars"></i>
                </button>
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        <li class="nav-item"><a class="nav-link px-lg-3 py-4 py-lg-4" href="index.php">Home</a></li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link px-lg-3 py-4 py-lg-4" href="blog.php">Blog</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link px-lg-4 py-3 py-lg-4" href="career.php">Career</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link px-lg-3 py-4 py-lg-4" href="about.php">About Us</a></li>
                        <li class="nav-item">
