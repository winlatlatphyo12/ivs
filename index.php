                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <label class="text-muted">Hands-On Lab</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <label class="text-muted">Chinese, English, Thai, Japanese, Korean</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <!-- End row -->
                    ...
                    <div class="row text-primary">
                        <div class="col-md-6 col-sm-6">
                            <div class="row">
                                <div class="col-sm-2">
                                    <i class="pe-7s-display2 pe-5x"></i>
                                </div>
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <label class="text-muted">On-Ground-Training & Internship</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <label class="text-muted">Authorized Exam / Training Center</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
